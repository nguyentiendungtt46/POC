...
//
//@Endpoint
//public class CicAuthenEndpoint {
//	private static final Logger logger = LogManager.getLogger(CicAuthenEndpoint.class);
//	private static final String NAMESPACE_URI = "http://www.endpoint.ws.h2h.cic.org.vn/cicauthen";
//
...
//
//	@PayloadRoot(namespace = NAMESPACE_URI, localPart = "DangNhap")
//	@ResponsePayload
//	public PHDangNhap sendAuthen(@RequestPayload DangNhap request, MessageContext messageContext) throws JAXBException {
//		PHDangNhap phDangNhap = new PHDangNhap();
...
//		try {
//			// validate
//			//String requestXml = logService.getRequestContent();
//			DangNhap hiddenPass = new DangNhap();
//			hiddenPass.setTenDangNhap(request.getTenDangNhap());
//			hiddenPass.setMatKhau("******");
//			logService.setRequestContent(Utils.convertObjToXML(hiddenPass, DangNhap.class));
//			if (verify) {
...
//						PHDangNhap res = authenService.buildLoginResponse(error);
...
//
//			// process
//			phDangNhap = authenService.sendAuthen(request);
//			
//			// end log
//			questionAnswerUtils.updateLog(logService, null, Constants.LOG_STATUS_SUCCESS, Constants.LOG_MESSAGE_SUCCESS,
//					Constants.ValidateCodeService.CMM_000, phDangNhap, null);
//		} catch (Exception e) {
//			logger.error(e.getMessage(), e);
//			PHDangNhap res = authenService.buildLoginResponse(Constants.ValidateCodeService.CMM_999);
