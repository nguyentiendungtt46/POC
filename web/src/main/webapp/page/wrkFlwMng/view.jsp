...
<tiles:insertDefinition name="catalog">
	<tiles:putAttribute name="title" value="Quản lý quy trình"/> 
	<tiles:putAttribute name="formInf">
		<spring:url value="/wrkFlwMng" var="formAction" />
	...
	<tiles:putAttribute name="catDetail" cascade="true">
		<form:hidden path="wrkFlwMng.id" id="id"/>
			<div class="box-custom">
				...
				<div class="Row">
		            ...
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "wrkFlwMng.code" cssClass="required uppercase ascii" />
		            </div>
		            <div class="label-static col-md-2 col-lg-2 col-sm-12 col-xs-12">Tên<font color="red">*</font></div>
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "wrkFlwMng.name" cssClass="required" title="tên không được để trống"/>
		            </div>
		            
		        </div>
		        <div class="Row">
		        	<div class="label-static col-md-2 col-lg-2 col-sm-12 col-xs-12">Loại dữ liệu<font color="red">*</font></div>
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "wrkFlwMng.caseType" cssClass="required" />
		            </div>
		        	<div class="label-static col-md-2 col-lg-2 col-sm-12 col-xs-12">Mô tả<font color="red">*</font></div>
		            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
		            	<form:input path = "wrkFlwMng.description" cssClass="required" title="mô tả không được để trống"/>
		            </div>
		        </div>
			</div>
	</tiles:putAttribute>
	...
	<tiles:putAttribute name="extra-scripts">
		...
		function initParam(tblCfg){	
            ...
            tblCfg.aoColumns = [			 
	            ...
	            {"sClass": "left","bSortable" : false,"sTitle":'Loại dữ liệu'},
	            {"sClass": "left","bSortable" : false,"sTitle":'Mô tả'},
	            {"sClass": "left","bSortable" : false,"sTitle":''}
            ];
		}
