...
<tiles:insertDefinition name="catalog">
	<tiles:putAttribute name="title"
		value="Báo cáo tình hình xử lý yêu cầu hỏi tin" />
	<tiles:putAttribute name="formInf">
		<spring:url value="/processQA" var="formAction" />
				...
				<div class="row search-style">
					<div class="Table" id="divSearchInf">
						<div class="row title-page" style="adding-bottom: 20px;">
							<h1>Báo cáo tình hình xử lý yêu cầu hỏi tin</h1>
						</div>
						<div class="Row">
						...
						<div class="row">
							...
							<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
								<form:select class="form-control" path="productCode"
									title="Chọn đơn vị">
									<option value="">- Chọn -</option>
		...
		<script type="text/javascript">
			...
			function exportExcel() {
				...
				window.open($('#theForm').attr('action')
						+ '?method=exportExcel&fromDate=' + fromDate + '&toDate=' + toDate + '&partnerId='+ partnerId + '&productCode='+productCode);
			}
